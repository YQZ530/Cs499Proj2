...
public class AndroidDebug : MonoBehaviour,IMessage
{
    public Text txtLog;
    public Text txtNewLog;
    public RectTransform RmsBar;

    public UnityAction<string> message { get; set; } = null;
    void Start()
    {
    ...
    {
        if (message != null) message.Invoke(_data);
        AddLog("Result: " + _data);
    }
    ...
    {
        if (message != null) message.Invoke(_params);
